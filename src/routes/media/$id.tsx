    ...
    <div className="min-h-svh">
      ...
      <main>
        <section className="relative min-h-[38rem] overflow-hidden">
          ...
          <div className="relative mx-auto grid min-h-[38rem] max-w-[100rem] items-end gap-8 px-4 pb-12 sm:px-6 md:grid-cols-[13rem_1fr] lg:px-10 xl:grid-cols-[16rem_1fr]">
