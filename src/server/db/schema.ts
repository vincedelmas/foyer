...
export const mediaItems = sqliteTable("media_items", {
    ...
    uniqueIndex("media_items_source_unique").on(table.libraryId, table.sourceKey),
])
...
export const mediaParts = sqliteTable("media_parts", {
    ...
    index("media_parts_episode_idx").on(table.mediaItemId, table.seasonNumber, table.episodeNumber),
]);
