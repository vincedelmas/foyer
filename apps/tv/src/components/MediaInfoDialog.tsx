...
const styles = StyleSheet.create({
    ...
    pill: { color: colors.text, backgroundColor: colors.surfaceRaised, paddingHorizontal: 11, paddingVertical: 7, borderRadius: 14, fontSize: 13, fontWeight: "700" },
    notice: { color: colors.primary, fontSize: 13 },
    ...
    path: { color: colors.muted, fontSize: 13, lineHeight: 18 },
    container: { color: colors.text, fontSize: 13, fontWeight: "800", borderWidth: 1, borderColor: colors.border, paddingHorizontal: 9, paddingVertical: 5, borderRadius: 7 },
    facts: { flexDirection: "row", flexWrap: "wrap", gap: 20 },
    fact: { width: 174, gap: 3 },
    factLabel: { color: colors.muted, fontSize: 13 },
    factValue: { color: colors.text, fontSize: 14, fontWeight: "700" },
    streams: { gap: 7 },
    subheading: { color: colors.text, fontSize: 15, fontWeight: "800" },
    streamText: { color: colors.muted, fontSize: 13, lineHeight: 18 },
