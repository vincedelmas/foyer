...
const styles = StyleSheet.create({
    ...
    connectionTitle: { color: colors.text, fontSize: 25, fontWeight: "800", letterSpacing: -0.4 },
    ...
    updateStatus: { color: colors.muted, fontSize: 10, lineHeight: 14 },
    ...
    libraryName: { color: colors.text, fontSize: 11, fontWeight: "800" },
    path: { color: colors.muted, fontSize: 8 },
    kind: { color: colors.text, fontSize: 8, fontWeight: "800", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10, backgroundColor: colors.background },
    connectionInline: { maxWidth: 850 },
    connectionForm: { gap: 10 },
    actions: { flexDirection: "row", justifyContent: "flex-end", gap: 9 },
    success: { color: colors.success, fontSize: 10, fontWeight: "700" },
    ...
    status: { color: colors.primary, fontSize: 8, fontWeight: "900", textTransform: "uppercase" },
    statusFailed: { color: colors.danger },
    emptyText: { color: colors.muted, fontSize: 10, textAlign: "center", paddingVertical: 30 },
});
