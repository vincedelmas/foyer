...
const styles = StyleSheet.create({
    ...
    connectionTitle: { color: colors.text, fontSize: 28, fontWeight: "800", letterSpacing: -0.4 },
    ...
    updateStatus: { color: colors.muted, fontSize: 13, lineHeight: 18 },
    ...
    path: { color: colors.muted, fontSize: 11 },
    kind: { color: colors.text, fontSize: 11, fontWeight: "800", paddingHorizontal: 9, paddingVertical: 5, borderRadius: 11, backgroundColor: colors.background },
    ...
    emptyText: { color: colors.muted, fontSize: 13, textAlign: "center", paddingVertical: 30 },
});
